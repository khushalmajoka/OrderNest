...
const LandingPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-r from-orange-100 to-white flex flex-row items-center justify-center px-4">
      <img src={OrderNestLogo} alt="OrderNest Logo" className="w-96" />
      <div className="flex flex-col items-center justify-center px-4">
        <h1 className="text-4xl font-bold text-gray-800 mb-2 font-poppins">OrderNest</h1>
